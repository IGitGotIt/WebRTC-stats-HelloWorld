...
-(void)configureHost {
    ...
    self.bytesSentHostView.allowPinchScaling = NO;
...
-(void)configurePlots {
    ...
    aaplPlot.identifier = kBytesSent;
...
-(void)configureAxes {
    ...
    CGFloat dateCount = 12;
    NSMutableSet *xLabels = [NSMutableSet setWithCapacity:dateCount];
    NSMutableSet *xLocations = [NSMutableSet setWithCapacity:dateCount];
    NSInteger i = 0;
    for (int count = 0; count < dateCount; count++) {
        CPTAxisLabel *label = [[CPTAxisLabel alloc] initWithText:[NSString stringWithFormat:@"%d",count]  textStyle:x.labelTextStyle];
        CGFloat location = i++;
